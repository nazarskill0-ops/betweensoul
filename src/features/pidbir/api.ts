...
import { MAX_RESULTS, type RequestValues } from "./schema";
...
/*
  ...
  а вибірку кандидатів замінити на запит із фільтрами (status/services/стать).
*/

export function findMatches(answers: RequestValues): MatchResult[] {
