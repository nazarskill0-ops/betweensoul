...
export function GoogleButton({ next }: { next?: string } = {}) {
  ...
  return (
    <button
      ...
      onClick={handleClick}
      disabled={loading}
      className="flex w-full items-center justify-center gap-2.5 rounded-full border-[1.5px] border-sand-dark bg-white py-3 text-sm font-medium text-ink transition-colors hover:border-sage disabled:opacity-60"
    >
