...
export const mockPsychologists: PsychologistProfile[] = [
  {
    ...
    sessionsCount: 640,
    formats: ["online"],
    services: ["Індивідуальна терапія"],
    topics: ["Тривога та панічні атаки", "Депресивні стани", "Вигорання та виснаження"],
    topicsSecondary: ["Самооцінка та невпевненість", "Проблеми зі сном"],
    ...
    reviews: [
      {
        ...
        rating: 5,
        topics: ["Проблеми зі сном", "Депресивні стани", "Самооцінка та невпевненість"],
      ...
      },
      {
        ...
        rating: 5,
        topics: ["Тривога та панічні атаки"],
      ...
      },
      {
        ...
        rating: 4,
        topics: ["Вигорання та виснаження"],
      ...
      },
      {
        ...
        rating: 5,
        topics: ["Депресивні стани", "Самооцінка та невпевненість"],
      ...
      },
      {
        ...
        rating: 5,
        topics: ["Вигорання та виснаження", "Самооцінка та невпевненість"],
      ...
      },
      {
        ...
        rating: 4,
        topics: ["Тривога та панічні атаки", "Проблеми зі сном"],
  ...
  },
  {
    ...
    sessionsCount: 1180,
    formats: ["online"],
    services: ["Індивідуальна терапія", "Парна терапія"],
    topics: ["З партнером", "Співзалежність"],
    topicsSecondary: ["Самотність та ізоляція"],
    topicsExcluded: ["Хімічні залежності", "Криза та травматичний досвід"],
  ...
  },
  {
    ...
    formats: ["online"],
    services: ["Індивідуальна терапія"],
    topics: ["З дітьми", "Самооцінка та невпевненість", "Розлади харчової поведінки"],
    topicsSecondary: ["Самотність та ізоляція"],
    ...
    reviews: [
      ...
      },
      {
        ...
        rating: 4,
        topics: ["Розлади харчової поведінки"],
  ...
  },
  {
    ...
    formats: ["online"],
    services: ["Індивідуальна терапія"],
    topics: ["Криза та травматичний досвід", "Втрата та горе"],
    topicsSecondary: ["Тривога та панічні атаки", "Нав'язливі думки"],
    topicsExcluded: ["Розлади харчової поведінки"],
    ...
    reviews: [
      {
        ...
        rating: 5,
        topics: ["Криза та травматичний досвід"],
  ...
  },
  {
    ...
    formats: ["online"],
    services: ["Індивідуальна терапія"],
    topics: ["Самотність та ізоляція", "Прокрастинація"],
    topicsSecondary: ["Вигорання та виснаження", "Пошук себе та професійне самовизначення"],
  ...
  },
  {
    ...
    sessionsCount: 760,
    formats: ["online"],
    services: ["Парна терапія", "Індивідуальна терапія"],
    topics: ["З партнером", "Вагітність та материнство", "Аб'юз та насильство"],
  ...
  },
  {
    ...
    formats: ["online"],
    services: ["Індивідуальна терапія"],
    topics: ["Розлади харчової поведінки", "Самооцінка та невпевненість"],
    topicsSecondary: ["Вигорання та виснаження", "Депресивні стани"],
    topicsExcluded: ["Криза та травматичний досвід", "Хімічні залежності"],
  ...
  },
  {
    ...
    formats: ["online"],
    services: ["Індивідуальна терапія"],
    topics: ["Вигорання на роботі", "Прокрастинація", "Втрата мотивації"],
    topicsSecondary: ["Пошук себе та професійне самовизначення"],
  ...
  },
  {
    ...
    formats: ["online"],
    services: ["Індивідуальна терапія", "Парна терапія"],
    topics: ["Вагітність та материнство", "Втрата та горе"],
    topicsSecondary: ["З партнером"],
    topicsExcluded: ["Хімічні залежності"],
    ...
    reviews: [
      {
        ...
        rating: 5,
        topics: ["Вагітність та материнство"],
  ...
  },
  {
    ...
    formats: ["online"],
    services: ["Індивідуальна терапія"],
    topics: ["Хімічні залежності", "Співзалежність"],
    topicsSecondary: ["Самотність та ізоляція"],
    topicsExcluded: ["Вагітність та материнство"],
  ...
  },
  {
    ...
    formats: ["online"],
    services: ["Індивідуальна терапія"],
    topics: ["Самотність та ізоляція", "Вигорання та виснаження"],
    topicsSecondary: ["Тривога та панічні атаки", "Депресивні стани"],
    topicsExcluded: ["Криза та травматичний досвід"],
  ...
  },
  {
    ...
    formats: ["online"],
    services: ["Індивідуальна терапія"],
    topics: ["Самооцінка та невпевненість", "Самотність та ізоляція"],
