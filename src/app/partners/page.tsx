...
const FAQ = [
  {
    ...
    a: "Абсолютно безкоштовно — і назавжди. Ми не беремо жодної плати з психологів ні за реєстрацію, ні за профіль, ні за рекламу. Calmi заробляє лише сервісний збір з клієнта в момент оплати сесії — і лише тоді, коли реально привели вам людину.",
  },
  {
  ...
  },
  {
    ...
    a: "Клієнт оплачує сесію через Calmi ще до її початку. Ми утримуємо невеликий сервісний збір і переказуємо решту суми вам. Все відбувається автоматично.",
  },
  {
  ...
  },
  {
    ...
    a: "Ми зв'яжемось з вами особисто, розповімо деталі і підтвердимо участь. Заявка ні до чого не зобов'язує.",
  },
];
    ...
    <>
      ...
      <section className="mx-auto max-w-5xl px-5 pt-16 pb-20 md:px-12 md:pt-24">
        <div className="max-w-2xl">
          <div className="mb-5 inline-flex items-center gap-2 rounded-full border border-sand-dark bg-white px-4 py-2 text-sm font-medium shadow-sm">
            ...
            Бета-доступ: залишилось <strong>12</strong> з 30 місць для
      ...
      <div className="bg-ink px-5 py-16 text-center md:px-12">
        <h2 className="mb-2 font-display text-2xl text-white md:text-3xl">
          Реєстрація для психологів — безкоштовна назавжди
        </h2>
