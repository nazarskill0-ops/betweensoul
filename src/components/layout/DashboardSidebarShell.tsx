...
/**
 * Спільний каркас бокової панелі для кабінетів (клієнта й психолога):
 * лого зверху, суцільна залита панель впритул до лівого краю на десктопі,
 * горизонтальні пігулки на мобільному. Набір пунктів меню — специфічний для
 * кожного кабінету, передається ззовні.
 */
