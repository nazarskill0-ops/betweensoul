...
CoupleScan ("we," "us," "our") provides an AI-powered relationship compatibility test available at couplescan.com. By using this website, you agree to these terms.
...
Our reports are generated by AI and are for entertainment and personal reflection purposes only. They do not constitute psychological, medical, therapeutic, or relationship counseling. Do not make life decisions based solely on your CoupleScan report. If you need professional help, please consult a licensed therapist or counselor.
...
All content on this website — including design, text, graphics, and code — is owned by CoupleScan. Your generated report is for your personal use only. You may share screenshots or excerpts on social media, but you may not resell or redistribute reports.

## 8. Limitation of Liability

CoupleScan is provided "as is" without warranties of any kind. We are not liable for any damages arising from your use of the service, including but not limited to emotional distress, relationship decisions, or actions taken based on report content.
...
When you take the CoupleScan test, we collect:
...
CoupleScan is not intended for anyone under 18. We do not knowingly collect data from minors.
...
We want you to be happy with your CoupleScan report. Here's how refunds work:
